...
export function Header() {
  ...
  return (
    <header className="sticky inset-x-0 top-0 z-50 w-full">
      {/* Opaque bg — factory.ai uses solid bg, not blur */}
      <div className="border-b border-dashed border-white/50 bg-[var(--bg-base)]">
        <div className="mx-auto flex items-center justify-between px-4 py-5 lg:px-9">
          {/* Logo — SVG mark + wordmark + blinking orange dot */}
          ...
          {/* Desktop nav — mono, uppercase, 12px */}
            ...
            {navLinks.map((link) => (
              <a
                ...
                className={cn(
                  ...
                  // Underline grow from left — factory.ai pattern
          ...
          {/* Desktop CTA — dark charcoal button, hover inverts to light + stripes */}
          <a
            href="#early-access"
            className={cn(
          ...
          >
            ...
            {/* Stripe overlay — appears on hover */}
            <span
              className={cn(
