...
import { vsContent } from './vs-content'
...
export async function renderVsOg(slug: 'jira' | 'linear' | 'notion') {
  const content = vsContent[slug]
  const [line1, line2] = content.ogHeadline.split('\n')
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Dashed inset border — wireframe-cell look */}
        <div
          style={{
            position: 'absolute',
            inset: 32,
